...
namespace RecoilStandalone
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            DispMulti = Config.Bind<float>(RecoilSettings, "Dispersion Recoil Multi", 0.85f, new ConfigDescription("Spread.", new AcceptableValueRange<float>(0f, 5f), new ConfigurationManagerAttributes { Order = 4 }));
            ...
            ConSemiMulti = Config.Bind<float>(RecoilSettings, "Semi Convergence Multi", 2.3f, new ConfigDescription("Recoil Autocompensation. Higher = Snappier Recoil, Smaller Initial Jump.", new AcceptableValueRange<float>(0f, 5f), new ConfigurationManagerAttributes { Order = 2 }));
