...
namespace RecoilStandalone
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            DispMulti = Config.Bind<float>(RecoilSettings, "Dispersion Recoil Multi", 0.9f, new ConfigDescription("Spread.", new AcceptableValueRange<float>(0f, 5f), new ConfigurationManagerAttributes { Order = 4 }));
