...
namespace RecoilStandalone
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            PlayerControlMulti = Config.Bind<float>(RecoilClimbSettings, "Player Control Strength.", 100f, new ConfigDescription("How Quickly The Weapon Responds To Mouse Input If Using The Hybrid Recoil System.", new AcceptableValueRange<float>(0f, 200f), new ConfigurationManagerAttributes { Order = 85 }));
            ...
            ResetSpeed = Config.Bind<float>(RecoilClimbSettings, "Reset Speed.", 0.005f, new ConfigDescription("How Fast The Weapon's Vertical Position Resets After Firing. Weapon's Convergence Stat Increases This.", new AcceptableValueRange<float>(0f, 5f), new ConfigurationManagerAttributes { Order = 60 }));
            ResetSensitivity = Config.Bind<float>(RecoilClimbSettings, "Reset Sensitvity.", 0.14f, new ConfigDescription("The Amount Of Mouse Movement After Firing Needed To Cancel Reseting Back To Weapon's Original Position.", new AcceptableValueRange<float>(0f, 5f), new ConfigurationManagerAttributes { Order = 50 }));
