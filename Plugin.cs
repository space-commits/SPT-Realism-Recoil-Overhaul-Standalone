...
namespace RecoilStandalone
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            SensLimit = Config.Bind<float>(RecoilSettings, "Sensitivity Lower Limit.", 0.55f, new ConfigDescription("Sensitivity Lower Limit While Firing. Lower Means More Sensitivity Reduction. 100% Means No Sensitivity Reduction.", new AcceptableValueRange<float>(0.1f, 1f), new ConfigurationManagerAttributes { Order = 8 }));
